...
public class CompanyCriteriaMain {
	...
	public static void main(String[] args) {
		...
		//for(CompanyCriteria cc : companyCriteria)
			System.out.println(companyCriteria);
			break;
		case 2:
		...
		case 3:
			...
			CompanyCriteria companyCriteriaOb = new CompanyCriteria(new CompanyDaoImpl().getCompany(cid1),yop,branch);
		...
		case 4:
			...
			CompanyCriteria companyCriteriaOb2 = new CompanyCriteria(new CompanyDaoImpl().getCompany(cid2),yop2,branch2);
