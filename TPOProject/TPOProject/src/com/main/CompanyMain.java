...
public class CompanyMain 
{
	...
	public static void main(String[] args) throws CompanyExistsException
	{
		...
		case 3:
			...
			Company companyOb = new Company(cid1,back,num,pool,cname,design,loc,sal,ssc,hsc,beagg);
		...
		case 4:
			...
			Company companyOb1 = new Company(cid2,back1,num1,pool1,cname1,design1,loc1,sal1,ssc1,hsc1,beagg1);
